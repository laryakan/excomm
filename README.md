...
**TLDR; Right click on a ship or station (outside the map), select "Extended Comm" then wait things to happen**
...
- steam : https://steamcommunity.com/sharedfiles/filedetails/?id=3487393047
